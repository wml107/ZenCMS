<template>
    <div id="resourceWorkbench">
        ...
        <div class="operation">
            ...
            <div class="copy">
                <svg t="1709780161644" class="icon" viewBox="0 0 1024 1024" version="1.1"
            ...
            <div class="cut">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-v-ea893728="">
                    <path fill="currentColor"
                        d="M256 768h672a32 32 0 1 1 0 64H224a32 32 0 0 1-32-32V96a32 32 0 0 1 64 0z"></path>
                    <path fill="currentColor"
                        d="M832 224v704a32 32 0 1 1-64 0V256H96a32 32 0 0 1 0-64h704a32 32 0 0 1 32 32"></path>
                </svg>
            </div>
            <div class="paste">
                <svg t="1709780184259" class="icon" viewBox="0 0 1024 1024" version="1.1"
            ...
            <div class="go">
                <svg t="1709780485071" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="4822" width="200" height="200">
                    <path
